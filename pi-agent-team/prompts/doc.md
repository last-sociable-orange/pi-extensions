...
## Work Flow
 ...
 6. Extract markdown file
  ...
  9. Upon user approval, move files from `.review` to parent folder
  10. Update `Knowledge/knowledge.md`. It is a one liner summary of the documents within the folder
